    ...
    class Fz223
    {
        public static Guid SaveAuctionInf(String html)
        {
            ...
            Object[][] md223 = new Object[][] { 
                // Закупка
                new Object[] { "номер",                                     "Общие сведения о закупке",     new String[] { "Номер извещения",                       "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "дата_размещения",                           "Общие сведения о закупке",     new String[] { "Дата размещения извещения",             "<td", ">" },           new String[] { "</td>" } },
                // Общие сведения о закупке
                new Object[] { "номер_извещения",                           "Общие сведения о закупке",     new String[] { "Номер извещения",                       "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "способ_размещения_закупки",                 "Общие сведения о закупке",     new String[] { "Способ размещения закупки",             "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "наименование_закупки",                      "Общие сведения о закупке",     new String[] { "Наименование закупки",                  "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "закупка_осуществляется_вследствие_аварии",  "Общие сведения о закупке",     new String[] { "Закупка осуществляется вследствие аварии", "<td", ">" },        new String[] { "</td>" } },
                new Object[] { "редакция",                                  "Общие сведения о закупке",     new String[] { "Редакция",                              "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "наименование_электронной_площадки",         "Общие сведения о закупке",     new String[] { "Наименование электронной площадки",     "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "адрес_электронной_площадки",                "Общие сведения о закупке",     new String[] { "Адрес электронной площадки",            "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "дата_размещения_извещения",                 "Общие сведения о закупке",     new String[] { "Дата размещения извещения",             "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "дата_размещения_текущей_редакции_извещения", "Общие сведения о закупке",    new String[] { "Дата размещения текущей редакции",      "<td", ">" },           new String[] { "</td>" } },
                // Заказчик
                new Object[] { "наименование_организации",                  "Заказчик",                     new String[] { "Наименование организации",              "<td", ">", "<a", ">" }, new String[] { "</a>" } },
                new Object[] { "инн_кпп",                                   "Заказчик",                     new String[] { "ИНН",                                   "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "огрн",                                      "Заказчик",                     new String[] { "ОГРН",                                  "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "адрес_места_нахождения",                    "Заказчик",                     new String[] { "Адрес места нахождения",                "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "почтовый_адрес",                            "Заказчик",                     new String[] { "Почтовый адрес",                        "<td", ">" },           new String[] { "</td>" } },
                // Контактное лицо
                new Object[] { "организация",                               "Контактное лицо",              new String[] { "Организация",                           "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "контактное_лицо",                           "Контактное лицо",              new String[] { "Контактное лицо",                       "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "электронная_почта",                         "Контактное лицо",              new String[] { "Электронная почта",                     "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "телефон",                                   "Контактное лицо",              new String[] { "Телефон",                               "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "факс",                                      "Контактное лицо",              new String[] { "Факс",                                  "<td", ">" },           new String[] { "</td>" } },
                // Требования к участникам закупки
                new Object[] { "требование_к_отсутствию_участников_закупки_в_реестре_недобросовестных_поставщиков",
                                                                            "Требования к участникам закупки",
                                                                                                            new String[] { "Требование к отсутствию",               "<td", ">" },           new String[] { "</td>" } },
                // Порядок размещения закупки
                new Object[] { "дата_и_время_окончания_подачи_заявок",      "Порядок размещения закупки",   new String[] { "Дата и время окончания подачи",         "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "дата_окончания_срока_рассмотрения_заявок",  "Порядок размещения закупки",   new String[] { "Дата окончания срока рассмотрения",     "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "дата_и_время_проведение_аукциона",          "Порядок размещения закупки",   new String[] { "Дата и время проведения",               "<td", ">" },           new String[] { "</td>" } },
                // Предоставление документации
                new Object[] { "срок_предоставления",                       "Предоставление документации",  new String[] { "Срок",                                  "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "место_предоставления",                      "Предоставление документации",  new String[] { "Место",                                 "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "порядок_предоставления",                    "Предоставление документации",  new String[] { "Порядок",                               "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "официальный_сайт",                          "Предоставление документации",  new String[] { "Официальный сайт",                      "<td", ">" },           new String[] { "</td>" } },
                new Object[] { "внесение_платы_за_предоставление_конкурсной_документации",
                                                                            "Предоставление документации",  new String[] { "Внесение платы",                        "<td", ">" },           new String[] { "</td>" } }
                };
            SqlCommand cmd = new SqlCommand
            {
                Connection = new SqlConnection(Env.cnString),
            ...
            {
                var bSect = new SectionIndexes(html, new String[] { (String)p[1] });
                if (bSect.HeadIsFound)
                {
                    var vSect = new SectionIndexes(html, (String[])p[2], bSect.Index1, (String[])p[3]);
                    String v = vSect.InnerText;
                    if (v != null)
                    {
