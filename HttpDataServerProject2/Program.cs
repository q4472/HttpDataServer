...
namespace HttpDataServerProject2
{
    class Program
    {
        ...
        public static void Main(String[] args)
        {
            ...
            // netsh http add urlacl url=http://+:11002/ user=SIBDOMAIN\Sokolov
            if (args != null)
            {
            ...
            Log.Write(String.Format("Start accept on 'http://{0}:11002/' with MainSqlServerDataSource: '{1}'.", HostIPv4, MainSqlServerDataSource));
            Server = new HttpServer();
            Server.OnIncomingRequest += new HttpServer.RequestDelegate(OnIncomingRequest);
            Server.Start("http://+:11002/");
        }
