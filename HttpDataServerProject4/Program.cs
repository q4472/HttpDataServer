...
namespace HttpDataServerProject4
{
    ...
    class Program
    {
        ...
        private static String V77FarmSibCnString1 = @"/d""\\SRV-TS2\dbase_1c$\Фармацея Фарм-Сиб"" /n""Соколов_Евгений_клиент_1"" /p""yNFxfrvqxP""";
        private static String V77FarmSibCnString2 = @"/d""\\SRV-TS2\dbase_1c$\Фармацея Фарм-Сиб"" /n""Соколов_Евгений_клиент_2"" /p""yNFxfrvqxP""";
        ...
        static void Main(string[] args)
        {
            ...
            // netsh http add urlacl url=http://+:11004/ user=DOMAIN\user
            if (args != null)
            {
            ...
            V77CnString = (ip.ToString() == "192.168.135.14") ? V77FarmSibCnString1 : V77FarmSibCnString2;

            Log.Write(String.Format("Start accept on 'http://{0}:11004/' with MainSqlServerDataSource: '{1}'.", ip, MainSqlServerDataSource));

            server = new HttpServer();
            server.OnIncomingRequest += new HttpServer.RequestDelegate(OnIncomingRequest);
            server.Start("http://+:11004/");
        }
